export default function ProgressBar({currentStepIndex, stepsLength}) {
    ...
    return (
        <div className={"mx-auto rounded-full h-full w-3 bg-grey-medium overflow-hidden"}>
            <div style={{ height: `${progressPercentage}%` }} className="w-full rounded-full transition-all duration-1000 overflow-hidden bg-red-medium"/>
        </div>
    );
}